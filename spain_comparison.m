...
%             end
           ...
           % axis off;
            ...
            axis([0 8 theta_white-5 theta_black+5]);
...
%             end
          pattern(strip)  
           axis off;
            ...
            subplot(10,1,[9 10]);
            hold on;
            plot(area_arr_angle(1:countt-1)/pitch^2, lca_arr(1:countt-1),'-r', 'LineWidth',2);
            plot(area_arr_angle(1:countt-1)/pitch^2, rca_arr(1:countt-1),'-g', 'LineWidth',2);
            plot(area_arr_angle(1:countt-1)/pitch^2, ca_fitted(1:countt-1),'--k', 'LineWidth',2);
